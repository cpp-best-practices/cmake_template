...
macro(myproject_tool_not_found_warning TOOL_NAME)
...
macro(myproject_enable_cppcheck WARNINGS_AS_ERRORS CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    myproject_tool_not_found_warning("cppcheck")
  endif()
endmacro()
...
macro(myproject_enable_clang_tidy target WARNINGS_AS_ERRORS)
  ...
  if(CLANGTIDY)
    ...
    myproject_tool_not_found_warning("clang-tidy")
  endif()
endmacro()
...
macro(myproject_enable_include_what_you_use)
  ...
  if(INCLUDE_WHAT_YOU_USE)
    ...
    myproject_tool_not_found_warning("include-what-you-use")
  endif()
endmacro()

macro(myproject_enable_lizard WARNINGS_AS_ERRORS)
  find_program(LIZARD lizard)
  if(LIZARD)
    include(cmake/Lizard.cmake)
    # Function defined in Lizard.cmake
    myproject_setup_lizard(${WARNINGS_AS_ERRORS})
  else()
